...
const Buscador = () => {
   ...
   const { handleBuscador, buscador, projects } = useProjects();
            ...
            >
               ...
               >
                  <div className='relative'>
                     <Combobox.Input
                        className='search-input h-12 w-full border-0 bg-transparent pl-4 pr-4 text-gray-800 placeholder-gray-400 focus:ring-0 sm:text-sm'
                        placeholder='Buscar...'
